...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VirgilCryptoAPI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL_NAMED("AccessTokenSigner")
...
SWIFT_PROTOCOL_NAMED("CardCrypto")
...
/// \param data raw public key representation
///
///
/// throws:
/// corresponding error
...
SWIFT_PROTOCOL_NAMED("PrivateKeyExporter")
