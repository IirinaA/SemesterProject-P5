...
- (NSArray<VSSRawSignedModel *> * _Nullable)searchCardsWithIdentity:(NSString * _Nonnull)identity token:(NSString * _Nonnull)token error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull commentStringPrefix;)
+ (NSString * _Nonnull)commentStringPrefix SWIFT_WARN_UNUSED_RESULT;
/// Comment string
///
/// returns:
/// Comment string for macOS Keychain entries
- (NSString * _Nonnull)commentString SWIFT_WARN_UNUSED_RESULT;
/// Created access for trusted application + current application
/// \param name entry nake
///
///
/// throws:
...
/// returns:
/// SecAccess
- (SecAccessRef _Nullable)createAccessForName:(NSString * _Nonnull)name error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull trustedApplications;
/// Init
/// \param appName Application name
///
/// \param trustedApplications List of trusted applications
///
- (nonnull instancetype)initWithAppName:(NSString * _Nonnull)appName trustedApplications:(NSArray<NSString *> * _Nonnull)trustedApplications OBJC_DESIGNATED_INITIALIZER;
/// Fabric method
/// \param trustedApplications List of trusted applications
///
///
...
+ (VSSKeychainStorageParams * _Nullable)makeKeychainStorageParamsWithTrustedApplications:(NSArray<NSString *> * _Nonnull)trustedApplications error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
