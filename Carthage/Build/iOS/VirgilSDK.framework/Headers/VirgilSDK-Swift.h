...
+ (VSSKeychainStorageParams * _Nullable)makeKeychainStorageParamsWithAccessGroup:(NSString * _Nullable)accessGroup accessibility:(NSString * _Nullable)accessibility error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
